...
#OJO AQUI! las @classmethod siembre deben ir indentadas dentro de la clase!!!
    ...
    def save(cls, form):
        ...
        return connectToMySQL('esquema_eventos').query_db(query, form) #Regresa el id del nuevo registro
    ...
    def get_by_email(cls, form):
        ...
        result = connectToMySQL('esquema_eventos').query_db(query, form) #Regresa Lista de Diccionario
    ...
    def get_by_id(cls, data):
        ...
        result = connectToMySQL('esquema_eventos').query_db(query, data) #Regresa Lista de Diccionario
        user = cls(result[0])
        return user
